...
namespace Library
{
    public static class ExtensionUtility
    {
        ...
        {
            if (result.HttpStatus == System.Net.HttpStatusCode.NoContent)
                return new NoContentResult();
            else if (result.Success && result.HttpStatus == System.Net.HttpStatusCode.OK)
        ...
        public static ListPagination<T> ToPaginationList<T>(this IEnumerable<T> list)
        {
            return new ListPagination<T>(list);
        }

        //public static ListPagination<T> ToResultPaginationList<T>(this ICollection<T> list)
        //{
        //    return new ListPagination<T>(list);
        //}

        public static Result<ListPagination<T>> ToResultPaginationList<T>(this IEnumerable<T> list)
        {
            return new Result<ListPagination<T>>(new ListPagination<T>(list));
        }
        ...
        public static bool IsNotNullOrEmpty(this string v)
        {
        ...
        public static long NullToDefaultOrValue(this object obj, long value)
        {
            return obj == null ? value : value;
        }
        ...
        public static string ComputeSHA256(this string password)
        {
            ...
            byte[] salt = "LuciferCore".GetUTF8Bytes();
